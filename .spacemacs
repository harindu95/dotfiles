...
(defun dotspacemacs/user-config ()
 ...
 you should place your code here."
  ...
  (defun save-and-indent()
    "fix indentation and save the buffer"
    (interactive)
  ...
  ;;Set Ctrl-f to find
  (define-key evil-visual-state-map (kbd "C-f") 'evil-search-forward)
  (define-key evil-insert-state-map (kbd "C-f") 'evil-search-forward)
  ...
  (define-key evil-insert-state-map "\C-z" nil)
  (define-key evil-visual-state-map "\C-z" nil)
  ...
  ;;Use Ctrl-d for multiple cursors
  (define-key evil-normal-state-map "\C-d" nil)
  (define-key evil-motion-state-map "\C-d" nil)
  (define-key evil-insert-state-map "\C-d" nil)
  (define-key evil-visual-state-map "\C-d" nil)
  (global-set-key (kbd "C-d") 'mc/mark-next-like-this)

  ;;Map <leader>w to kill the buffer and <leader>q to close emacs
  ;;(global-key-binding (kbd ",w") 'kill-buffer-and-window)
  ;;(global-key-binding (kbd ",q") 'kill-emacs)
